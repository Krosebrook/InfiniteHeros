                ...
                <div className="mb-8 relative z-10">
                     ...
                     <div className="relative mt-2">
                         <select 
                            ...
                            className="w-full border-4 border-black p-3 md:p-4 font-comic text-xl md:text-2xl bg-white focus:ring-4 focus:ring-yellow-400 outline-none appearance-none shadow-[4px_4px_0px_rgba(0,0,0,1)] cursor-pointer"
                         >
